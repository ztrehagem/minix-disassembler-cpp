...
public:
  ...
  static string data_str_wide(const unsigned short data, const bool nat = false, const bool sign = false);
  static string data_str_narrow(const unsigned char data, const bool nat = false, const bool sign = false);
